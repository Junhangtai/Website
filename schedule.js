function Lesson(id, title, category, day, img, desc){
    this.id = id;
    this.title = title;
...
const yoga6 = new Lesson(6,"Clinical Pilates","pilates","Saturday", "images/pilate2.jpg", "Clinical Pilates is a therapeutic exercise offered by some qualified physiotherapists as a part of treatment for various injuries and health conditions.");
